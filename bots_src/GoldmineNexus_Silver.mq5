...
bool DailyLossExceeded() {
    ...
    if(key != dayKey) {
        ...
        Print("Nexus Silver: Daily equity reset. StartEquity=", DoubleToString(dayStartEquity, 2));
    }
    ...
    if(!dailyLossTripped && lossPct >= DailyLossPctFromStart) {
        ...
        Print("Nexus Silver: DAILY LOSS GUARD TRIPPED. Loss=", DoubleToString(lossPct, 2), "% (cap ", DoubleToString(DailyLossPctFromStart, 2), "%). New entries blocked.");
    }
